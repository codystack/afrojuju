                    ...
                    <section className="container pb-5 mb-md-2 mb-lg-4 mt-5 pt-5">
                        ...
                        <div className="row pt-2 pt-md-3">
                            <div className="col-md-">
                                ...
                                <p className="mb-5"><strong>Automatically Collected Information:</strong><br />
                                ...
                                <p className="mb-5">Our App is not intended for individuals under the age of 18. We do not knowingly collect personal information from children. If you believe that we may have collected information from a child without parental consent, please contact us, and we will promptly delete the information.</p>
